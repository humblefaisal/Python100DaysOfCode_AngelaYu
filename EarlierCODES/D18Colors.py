colors = [
    ...
    "medium turquoise", "turquoise", "cyan", "light cyan",
    ...
    "indian red", "saddle brown", "sienna", "peru", "burlywood",
    "beige", "wheat", "sandy brown", "tan", "chocolate", "firebrick",
    "brown", "dark salmon", "salmon", "light salmon", "orange",
    ...
    "purple", "medium purple", "thistle", "snow2", "snow3", "snow4",
    "seashell2", "seashell3", "seashell4", "AntiqueWhite1", "AntiqueWhite2",
    "AntiqueWhite3", "AntiqueWhite4", "bisque2", "bisque3", "bisque4",
    "PeachPuff2", "PeachPuff3", "PeachPuff4", "navajo white2",
    "navajo white3", "navajo white4", "LemonChiffon2", "LemonChiffon3",
    ...
    "DeepSkyBlue2", "DeepSkyBlue3", "DeepSkyBlue4", "SkyBlue1",
    ...
    "LightYellow4", "yellow2", "yellow3", "yellow4", "gold2", "gold3",
    "gold4", "goldenrod1", "goldenrod2", "goldenrod3", "goldenrod4",
    ...
    "coral3", "coral4", "tomato2", "tomato3", "tomato4", "OrangeRed2",
    ...
    "maroon1", "maroon2", "maroon3", "maroon4", "VioletRed1",
    "VioletRed2", "VioletRed3", "VioletRed4", "magenta2", "magenta3",
...
explosion_colors = [
    # Bright fire & flames
    "orange", "dark orange", "coral", "tomato", "orange red", "red",
    "firebrick", "brown", "chocolate", "saddle brown",
    "peru", "sienna", "indian red", "salmon", "dark salmon",

    # Yellows & glowing
    "yellow", "gold", "light goldenrod", "goldenrod", "dark goldenrod",
    "khaki", "dark khaki", "pale goldenrod",

    # Smoke & ash
    "gray", "dim gray", "light grey", "dark slate gray", "rosy brown",
    "burlywood", "tan", "wheat", "beige", "light coral",

    # Bright hot sparks
    "hot pink", "deep pink", "pale violet red", "maroon",

    # Variants (for glowing/variation)
